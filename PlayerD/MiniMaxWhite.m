function [BestBewertung, BestZug, BestBrett] = MiniMaxWhite(Brett, A, B, Tiefe, Move_No, Akt_Zug, Store_ValidPos)
maximal = -Inf;
BestZug = [];
BestZugIndex = [];
BestBrett = [];
        ...
        return
            ...
            for k = 1:ValidPosNum
               ...
               % inner_stones = Inner_Counter(ValidPos(k,1), ValidPos(k,2), Temp_Brett(:,:,k));
                Temp_Bewertung = MiniMaxBlack(Temp_Brett(:,:,k), A, B, Tiefe-1, Move_No+1,ValidPos(k,:),Store_ValidPos);
